...
fn parse_serial_descriptor_acer_ek221q_h() {
    ...
    let serial = Monitor::parse(&serial_raw).expect("serial descriptor parse");
...
fn parse_product_name_descriptor_acer_ek221q_h() {
    ...
    let name = Monitor::parse(&name_raw).expect("name descriptor parse");
...
fn parse_text_descriptor_lenovo_lp156wf9_spk2() {
    ...
    let text = Monitor::parse(&text_raw).expect("text descriptor parse");
...
fn parse_std_timings2_descriptor_rol_rolsen_c707n() {
    ...
    let std = Monitor::parse(&std_raw).expect("std timings2 parse");
...
fn parse_dcm_descriptor_vit_vt988() {
    ...
    let dcm = Monitor::parse(&dcm_raw).expect("dcm descriptor parse");
